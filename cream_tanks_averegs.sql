-- Средняя температура стерилизации  танка за сегодня, вчера, позавчера, позапозавчера + за конкретную дату
...
cast(avg(t_tank03) as numeric(5,2)) t3
from (select t_tank03 from table1 where t_tank03 > 80 
and table1.current_time between to_timestamp('2022/01/25 00:00','YYYY/MM/DD HH24:MI') and to_timestamp('2022/01/14 00:00','YYYY/MM/DD HH24:MI')
     ) tab3) tt3
inner join (
select 
cast(avg(t_tank01) as numeric(5,2)) t1
